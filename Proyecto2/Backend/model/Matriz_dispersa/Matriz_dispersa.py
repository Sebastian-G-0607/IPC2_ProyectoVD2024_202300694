from model.Matriz_dispersa.Lista_cabecera import ListaCabecera
from model.Matriz_dispersa.nodo_cabecera import NodoCabecera
from model.Matriz_dispersa.nodo_celda import NodoCelda
...
class MatrizDispersa:
    ...
    '''
        ...
        grafo = Source(codigodot, format="svg")
        imagen_fuente = grafo.pipe()
        imagen_64 = base64.b64encode(imagen_fuente).decode("UTF-8")
        return imagen_64