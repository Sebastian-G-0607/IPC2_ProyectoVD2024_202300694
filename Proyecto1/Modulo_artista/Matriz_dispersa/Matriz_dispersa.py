...
from Modulo_artista.Matriz_dispersa.Lista_cabecera import ListaCabecera
from Modulo_artista.Matriz_dispersa.nodo_cabecera import NodoCabecera
from Modulo_artista.Matriz_dispersa.nodo_celda import NodoCelda
...
class MatrizDispersa:
    ...
    def graficar(self,id_figura):
        ruta_dot = 'Proyecto1/codigosdot/Matriz_'+id_figura+'.dot'
    ...
    '''
        ...
        ruta_imagen = 'Proyecto1/Reportes/Matriz_' + id_figura + '.png'
        comando = 'dot -Tpng '+ ruta_dot + ' -o '+ ruta_imagen
        os.system(comando)


        #Generamos la imagen
        ruta_svg = 'Proyecto1/Reportes/Matriz_'+id_figura+'.svg'
